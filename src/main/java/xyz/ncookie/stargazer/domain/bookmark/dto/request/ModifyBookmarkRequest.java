...
public record ModifyBookmarkRequest(
	@Schema(description = "북마크 이름 (최대 50자)", example = "제주도 별보기 명소 (수정)", maxLength = 50)
	@Size(max = 50, message = "북마크 이름은 최대 50자까지 입력 가능합니다.")
	@NotBlank(message = "수정할 북마크 이름은 필수입니다.")
	String name,

	@Schema(description = "메모 (선택, 최대 500자)", example = "밤하늘이 정말 맑아서 별이 잘 보이는 곳입니다. 다시 가고 싶은 곳!", maxLength = 500)
